...
- Create Angular project with ng: `ng new fileuploaderapi.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`fileuploaderapi.client.esproj`).
